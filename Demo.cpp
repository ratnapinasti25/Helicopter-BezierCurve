...
void Demo::Update(double deltaTime) {
	angle += (float)((deltaTime * 25.0f) / 1000);
}
...
void Demo::Render() {
	...
	glm::mat4 view = glm::lookAt(glm::vec3(px, py, 40), glm::vec3(px, py, 0), glm::vec3(0, 1, 0));
...
void Demo::DrawColoredCube() //baling2
{
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(px, 3+py, 0));

	model = glm::rotate(model, angle, glm::vec3(0, 1, 0));

	model = glm::scale(model, glm::vec3(10, 0.5, 2));
...
void Demo::DrawColoredCube1() //bawah baling2
{
	glUseProgram(shaderProgram);
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(px, 2+py, 0));
...
void Demo::DrawColoredCube2() // badan
{
	glUseProgram(shaderProgram);
...
void Demo::DrawColoredCube3() // belakang
{
	glUseProgram(shaderProgram);
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(6.5+px, py, 0));

	model = glm::scale(model, glm::vec3(8, 1.2, 3));
...
void Demo::DrawColoredCube4() //baling2 belakang
{
	glUseProgram(shaderProgram);
	...
	glm::mat4 model;
	model = glm::translate(model, glm::vec3(9.5+px, py, 1.5));
...
int main(int argc, char** argv) {
	...
	app.Start("Latihan: Helicopter", 1200, 600, false, false);
}